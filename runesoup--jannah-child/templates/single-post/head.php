...
$post_layout = tie_get_object_option( 'post_layout', 'cat_post_layout', 'tie_post_layout' );		
				if( ! empty( $post_layout ) && ( $post_layout == 1 ) ){ ?> 
		<hr class="wp-block-separator has-text-color has-background is-style-wide rs-ruled-line" style="background-color:#247b1a;color:#247b1a">
			<?php
		}
	?>
	</div><!-- .entry-header /-->
