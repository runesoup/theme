...
<div class="opc-pricing-table-product product-item cart ">
	<div class="opc-pricing-table-product-header">
			<div class="opc-pricing-table-product-price rs-price-main"><p>
				...
				<span class="subscription-details"> per month - First 3 months prepaid for <span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">USD$</span>30.00</bdi></span></span></p></div><div class="product-quantity rs-opc-table-button"> 
		<button class="button gift-link" id="gift-link"> <span>Give Now</span> </button> 
		</div>
	</div>
